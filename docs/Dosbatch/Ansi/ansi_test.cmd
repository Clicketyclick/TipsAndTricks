...
GOTO :EOF
    ...
    call :loop_all_colors   :: Loop all colors
...
:loop_all_colors
    ECHO %0 :: Loop all colors
    ECHO Loop through all colors
    FOR /L %%f IN (0,1,7) DO (
        FOR /L %%b IN (0,1,7) DO (
...
|7       |[[reverse video]]              |swap foreground and background colors    |OK
...
|29      |Not crossed out                |   | ?
    |30–37   |Set foreground color           |See color table below   | OK
    |38      |Set foreground color           |Next arguments are 5;<n> or 2;<r>;<g>;<b>, see below   | OK
|39      |Default foreground color       |implementation defined (according to standard)   | ?
    |40–47   |Set background color           |See color table below   | OK
    |48      |Set background color           |Next arguments are 5;<n> or 2;<r>;<g>;<b>, see below   | OK
...
|65      |ideogram attributes off        |reset the effects of all of 60-64   | ?
    |90–97   |Set bright foreground color    |aixterm (not in standard)   | OK
    |100–107 |Set bright background color    |aixterm (not in standard)   | OK 
